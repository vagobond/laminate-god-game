...
- [ ] **3. RLS/visibility test suite.** Zero tests in 49.5K LOC. Minimum viable: "user A cannot see user B's private entry / secret friendship / blocked content" against a shadow DB in CI, run after migrations. This guards the 236 policies that ARE the product's trust promise.
