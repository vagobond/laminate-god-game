-- Fix handle_new_user to lowercase BEFORE removing special chars
...
BEGIN
  ...
  -- LOWERCASE FIRST, then remove special chars (fixes the bug where uppercase letters were stripped)
