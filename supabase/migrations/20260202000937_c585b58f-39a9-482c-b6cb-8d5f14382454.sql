...
-- Align INSERT policy with frontend eligibility: allow buddy+ (incl family) friendship in either direction
...
WITH CHECK (
  ...
  AND (
    -- Friends (Buddy and above, plus Family) — either direction
    EXISTS (
      SELECT 1
